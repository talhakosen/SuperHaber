 ...
 */
public final class GetCategories extends BaseRequest {

    public GetCategories(String url,JSONObject object,Listener<JSONObject> listener, ErrorListener errorListener) {
